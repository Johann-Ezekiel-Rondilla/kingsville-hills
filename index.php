				...
				document.addEventListener('DOMContentLoaded', function() {
					...
					var calendar = new FullCalendar.Calendar(calendarEl, {
						...
						dateClick: function(info) {
							...
							var modalTitle = new Date(selectedDate).toLocaleDateString();

							document.getElementById("scheduleTitle").textContent = "Schedules for " + modalTitle;

							var eventList = "";

							if (eventsForDay.length === 0) {
								eventList = "<p>No scheduled events.</p>";
							} else {
								...
								eventList = "<ul class='list-group'>";

								eventsForDay.forEach(function(event) {

									var time = event.start.toLocaleTimeString([], {hour:'2-digit', minute:'2-digit'});
									var description = event.extendedProps.description || "";

									eventList += "<li class='list-group-item'>" +
							...
							document.getElementById("scheduleDescription").innerHTML = eventList;
							document.getElementById("scheduleDate").textContent = modalTitle;
